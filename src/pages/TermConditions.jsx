  ...
  return (
    <>
      <div className="main container p-5">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to AthleticForce1CRM.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to AthleticForce1CRM, accessible
              from{" "}
              <a
                href="https://af1crm.netlify.app/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://af1crm.netlify.app/
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: info@techspherelogix.com</li>
        </ul>
      </div>
    </>
  );
