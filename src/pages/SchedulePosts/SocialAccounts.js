    ...
    <>
      <main>
        <>
          <header className="container-fluid header-custom">
            ...
            <div className="dropdown-custom">
              ...
              >
                ...
                <li>
                  <a className="dropdown-item dropdown-item-custom" href="#">
                    <i className="fa-solid fa-lock icon-drowp-status" /> Locked
                    Accounts
                  </a>
                </li>
              </ul>
            ...
            <div className="dropdown-custom">
              ...
              >
                ...
                <li>
                  <a className="dropdown-item dropdown-item-custom" href="#">
                    <i className="fa-brands fa-square-google-plus" /> Google
                  </a>
                </li>
              </ul>
            </div>
          ...
          {/* Main Container */}
          <div className="add-social-accounts">
                        ...
                        <div className="modal-content fb-modal-content">
                          <div className="fb-modal-header modal-header">
                            ...
                            >
                              ...
                              <a
                                href="#"
                                className="btn btn-primary icon-fb-like"
                              >
                          ...
                          <div className="fb-modal-body modal-body">
                            <div className="row text-center">
                              <div
                                className="col-md-3 col-6 fb-model-se-col fb-model-se-col
"
                              >
